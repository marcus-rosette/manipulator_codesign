...
data = np.loadtxt("./data/arc_manipulability.csv")
...
plt.plot(prune_point[1], prune_point[2], marker='o', color='red', markersize=15)
plt.scatter(branch_loc[0], branch_loc[1], s=5000, edgecolor='brown', facecolors='none', linewidths=3)

# Add custom legends (mainly to reduce the marker size)
prune_marker = plt.Line2D([0], [0], marker='o', color='red', markersize=15, linestyle='None', label='Prune Point')
branch_marker = plt.Line2D([0], [0], marker='o', color='brown', markersize=15, linestyle='None', markeredgewidth=2, markerfacecolor='none', label='Branch Location')
