...
if __name__ == "__main__":
    path_cache = PathCache(robot_urdf_path="./urdf/ur5e/ur5e_cart.urdf", planar=False, renders=True)
    ...
    path_cache.find_high_manip_ik(voxel_centers, num_hemisphere_points, look_at_point_offset, hemisphere_radius, save_data_filename=save_data_filename)
