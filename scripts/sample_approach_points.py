...
class SamplePoints:
    def __init__(self, con, planar: bool) -> None:
        self.con = con
        self.planar = planar
    ...
    def prune_arc(self, prune_point, radius, allowance_angle, num_arc_points, y_ori_default=0.0, z_ori_default=0):
        ...
        for i in range(num_arc_points):
            ...
            goal_orientations[i] = self.con.getQuaternionFromEuler([-arc_angles[i], y_ori_default, z_ori_default])
    ...
    def hemisphere_orientations(self, point1, points2):
        """
